  ...
  return (
    <div className="h-auto w-full text-gray-700 antialiased">
      ...
      <div className="bg-gray-300">
        ...
        <main className="content  text-xl  "><div className="h-auto bg-gray-900">
        ...
        <footer className="border-t border-gray-300 py-8 text-center text-sm">
          ...
          <br />This work is licensed under a <a rel="license" href="https://opensource.org/license/mit/"> MIT license</a>
        </footer>
        <CookieBanner />
      </div>
    </div>
